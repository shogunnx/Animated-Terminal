export default function HoloPortrait({ name="UNKNOWN", accent="#76FFE1", glow="#8C50FF" }) {
  // Built-in “portrait” so you’re not stuck waiting on images.
  return (
    <svg viewBox="0 0 420 520" width="100%" height="100%" style={{ display:"block" }}>
      ...
      <rect x="0" y="0" width="420" height="520" rx="24" fill="url(#bg)"/>
      <circle cx="210" cy="120" r="160" fill="url(#halo)"/>

      {/* Hologram bust silhouette */}
      <g opacity=".92">
        <path
      ...
      {/* Glow rim */}
      <rect x="8" y="8" width="404" height="504" rx="26" fill="none" stroke={accent} strokeOpacity=".22" />
      <rect x="14" y="14" width="392" height="492" rx="22" fill="none" stroke={glow} strokeOpacity=".16" filter="url(#soft)" />
    </svg>
  );
}

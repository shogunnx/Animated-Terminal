export const TSV_CHARACTERS = [
  ...
  // optional
  { id:"veronica", name:"Veronica", subtitle:"Human ally quarters (optional)", accent:"#FFB84D", glow:"#63B3FF", portrait:"/assets/portraits/veronica.png" },
];

export const TSV_ROOMS = {
  victoria_black: {
    title: "Victoria Black — Goddess Chamber",
    vibe: "Elegant, dangerous, calm. Teal-gold glass, soft power.",
    bgImage: "/assets/rooms/victoria_black.jpg",
  ...
  wargirl: {
    ...
    bgImage: "/assets/rooms/wargirl.jpg",
  ...
  binary: {
    ...
    bgImage: "/assets/rooms/binary.jpg",
  ...
  vanessa: {
    ...
    bgImage: "/assets/rooms/vanessa.jpg",
  ...
  harmony: {
    ...
    bgImage: "/assets/rooms/harmony.jpg",
  ...
  evil_victoria: {
    ...
    bgImage: "/assets/rooms/evil_victoria.jpg",
  ...
  veronica: {
    title: "Veronica — Human Quarters (Optional)",
    vibe: "Warm human space. Engineering sketches and tools.",
    bgImage: "/assets/rooms/veronica.jpg",
